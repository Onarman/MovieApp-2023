...
const SliderCard = ({ id, title, poster_path, vote_average }) => {
  ...
  return (
      ...
      <div className="slider-movie-card"onClick={()=> {navigate("/details/" +id)
      !currentUser && toastWarnNotify("Please log in to see detail")}}>
       <div className="slider-card-content">
        ...
        <div className="slider-card-buttom">
          <h5>{title}</h5>
          <h5 className="slider-vote">{vote_average}</h5>
        </div>
      </div>
